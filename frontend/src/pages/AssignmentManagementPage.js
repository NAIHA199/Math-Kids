...
const AssignmentManagementPage = () => {
  ...
  const mockAssignments = [
    { id: 'BT01', name: 'Bài tập Phép nhân', class: 'Lớp 3A', assignedDate: '20/08/2025', dueDate: '25/08/2025', status: 'in-progress' },
    { id: 'BT02', name: 'Ôn tập Phân số', class: 'Lớp 4B', assignedDate: '18/08/2025', dueDate: '22/08/2025', status: 'completed' },
    { id: 'BT03', name: 'Số thập phân nâng cao', class: 'Lớp 5C', assignedDate: '15/08/2025', dueDate: '19/08/2025', status: 'overdue' },
    { id: 'BT04', name: 'Bài tập Phép chia', class: 'Lớp 3A', assignedDate: '21/08/2025', dueDate: '26/08/2025', status: 'in-progress' },
    { id: 'BT05', name: 'Luyện tập chung', class: 'Lớp 4B', assignedDate: '22/08/2025', dueDate: '28/08/2025', status: 'in-progress' },
  ];
